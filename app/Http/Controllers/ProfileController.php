...
class ProfileController extends Controller
{
    ...
    public function saveHobbies(Request $request, $username){
        ...
        $request->session()->flash('alert-success', '¡Tus pasatiempos se han actualizado con éxito!');
    ...
    public function saveRelationship(Request $request, $username){
        ...
        if ($relation->save()) {
            ...
            $request->session()->flash('alert-success', 'Su relación ha sido solicitada con éxito! Él / Ella debe aceptar la relación con usted para publicar.');
