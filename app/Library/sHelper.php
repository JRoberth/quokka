...
class sHelper
{
    ...
    public static function followButton($following, $follower, $element, $size = ''){
        ...
        if ($following  == $follower) return "Soy yo";
        ...
        return '<a href="javascript:;" class="btn btn-default follow-button '.$size.'" onclick="follow('.$following.', '.$follower.', \''.$element.'\', \''.$size.'\')"><i class="fa fa-plus-circle"></i> Seguir</a>';
        ...
        if (self::$notifications == null){
            ...
            if ($followers > 0){
                $notifications[] = [
                    ...
                    'icon' => 'fa-user-plus',
                    'text' => $followers.' solicitudes de seguidores'
                ];
            }
            ...
            if ($relatives > 0){
                $notifications[] = [
                    ...
                    'text' => $relatives.' solicitudes de familiares'
                ];
            }
            ...
            if ($comments->count() > 0){
                ...
                $name = DB::table('users')->where('id',$comment->comment_user_id)->value('name');
                    $notifications[] = [
                        ...
                        'icon' => 'fa-commenting',
                        'text' => $name.' comento tu publicacion.'
                    ];
                }
            ...
            if ($likes->count() > 0){
                foreach ($likes as $likne){
                    ...
                    $notifications[] = [
                        ...
                        'icon' => 'fa-heart',
                        'text' => 'a '. $name.' le gusta tu publicacion.'
                    ];
                }
