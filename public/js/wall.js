            ...
            action: function(dialog) {
                ...
                $.ajax({
                    ...
                    success: function(response){
                        dialog.close();
                        if (response.code == 200){
                            $('#panel-post-'+id).html("¡Publicacion borrada!");
                        }else{
                            $('#errorMessageModal').modal('show');
                            $('#errorMessageModal #errors').html('¡Algo salio mal!');
                        }
