    ...
    <div class="row">
        <div class="col-md-6">
            <a href="{{ url('/') }}" class="logo">
                <img src="{{ asset('images/quokka.png') }}" alt="" />
            </a>
        </div>
        ...
        <div class="col-md-6">
            ...
            <div class="tab_container">
                ...
                <label for="tab1" class="head"><i class="fa fa-user"></i><span>INGRESAR</span></label>

                <input id="tab2" type="radio" name="tabs" {{ old('tab') == 'register' ? 'checked' : '' }} class="radio_hidden">
                <label for="tab2" class="head"><i class="fa fa-user-plus"></i><span>¡REGÍSTRARSE!</span></label>
